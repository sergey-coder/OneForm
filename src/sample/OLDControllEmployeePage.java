...
public class OLDControllEmployeePage implements Initializable {
    @FXML
    ...
    // реализация выпадающего спика для выбора должности________________________________________________
        ...
        public void BuilderDoc() throws SQLException {
            ...
            int y =1;
            text.append("Начат проход DataSet1" + "\n" + "длинна сета составляет : " + x);
            ...
            text.append("\n" + "Начат проход DataSet2" + "\n" + "длинна сета составляет : " + x2);
    ...
    @FXML
    public void notGoalMause3(MouseEvent mouseEvent) {createDoc.setStyle("-fx-background-color: #098BF3");}
